package course.dio.Lists.Intefaces.Stream;
...
public class RefatoraçãoMap {
    public static void main(String[] args) {
        ...
        for (Map.Entry<Integer, Contato> contatos: agenda.entrySet()
              ) {
            System.out.println(contatos.getKey()+"-" + contatos.getValue().getNumero());
        ...
        for (Map.Entry<Integer, Contato> contatos: agenda1.entrySet()
        ) {
            System.out.println(contatos.getKey()+"-" + contatos.getValue().getNumero());
        }
